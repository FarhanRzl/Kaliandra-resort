  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col">
        <header className="bg-white shadow-md">
          <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Kaliandra</span>
            </div>
        ...
        <footer className="bg-[#1E4C3B] text-white py-12">
          <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm italic">
                Menghadirkan perumahan modern dengan desain berkualitas,
                fasilitas lengkap, dan akses strategis untuk menunjang gaya
                hidup masa kini.
              </p>
            </div>
            <div>
            ...
            <div className="md:col-span-3 border-t border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center">
